...
-- allergy 7 Peanuts
INSERT INTO allergy (allergyId, allergyImage, allergyImageAlt, allergyName)
VALUES (UUID_TO_BIN(UUID()), 'https://georgiagrown.com/wp-content/uploads/2019/10/featured_fruitsveg-peanuts.jpg', 'peanuts image', 'Peanuts');

-- allergy 8 Tree Nuts
INSERT INTO allergy (allergyId, allergyImage, allergyImageAlt, allergyName)
VALUES (UUID_TO_BIN(UUID()), 'https://cdn.shopify.com/s/files/1/2531/6758/articles/tree_nuts_3_1024x1024.jpg?v=1611863316', 'tree nuts image', 'Tree nuts');
