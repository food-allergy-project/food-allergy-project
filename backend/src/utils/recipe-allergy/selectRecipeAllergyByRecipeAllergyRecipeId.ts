...
export async function selectRecipeAllergyByRecipeAllergyRecipeId (recipeAllergyRecipeId: string) : Promise<RecipeAllergy[]> {
    ...
    const mySqlQuery : string = "SELECT BIN_TO_UUID(recipeAllergyRecipeId) as recipeAllergyRecipeId, BIN_TO_UUID(recipeAllergyProfileId) as recipeAllergyProfileId FROM recipeAllergy WHERE recipeAllergyRecipeId = UUID_TO_BIN(:recipeAllergyRecipeId)"
